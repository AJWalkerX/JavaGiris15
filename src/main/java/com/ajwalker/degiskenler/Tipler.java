...
public class Tipler {
	...
	public static void main(String[] args) {
		...
		/**
		 * Big Decimal - Hatasız ondalıklı sayılarla çalışmanızı sağlar.
		 */
		/**
		 * declaration
		 */
		 ...
		 */
		var kilo = 7.67;
		//kilo="asda"; tip çıkarımı sayesinde kilo değişkeni double olarak ayarlanmıştır. Sonradan string değer
		// taşıyamaz.
		var yas = 17;
		var uyruk = "TC";
		var evliMi = true;
